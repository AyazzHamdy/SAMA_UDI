...
def bteq_temp_script(cf, source_output_path, STG_tables,script_flag):
    ...
    for stg_tables_df_index, stg_tables_df_row in stg_tables_df.iterrows():
        ...
        stg_equal_updt_cols = funcs.get_conditional_stamenet(STG_tables, Table_name, 'stg', '=', None, 'datamart')
...
#dup database
        ...
        if script_flag == 'from stg to datamart':
            ...
            bteq_script = template_string.format(bteq_run_file=bteq_run_file,oi_prefix=oi_prefix,
